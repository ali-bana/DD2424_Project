...
def get_data_loader(batch_size=256):
    ...
    train_svhn = datasets.SVHN(
        'data', split='train', download=True, transform=tx)
    test_svhn = datasets.SVHN('data', split='test',
    ...
    tesr_loader = DataLoader(test_loader, batch_size=batch_size, shuffle=True)
